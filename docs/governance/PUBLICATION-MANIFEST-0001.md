...
- DCO signoff check;
- scan for private repository name, private paths and known prompt identifiers;
- license and required-file verification;
- no simulation, physics, engine, renderer, ML, asset or dataset content.
